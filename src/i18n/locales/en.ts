...
export const en: Locale = {
  ...
  certs: {
    ...
    items: ['C Essentials 1', 'C Essentials 2', 'C Advanced', 'C++ Essentials 1', 'C++ Essentials 2', 'C++ Advanced', 'Endpoint Security', 'Network Defense', 'Network Technician Career Path', 'Linux Unhatched', 'Cyber Threat Management', 'Front-End Developer'],
